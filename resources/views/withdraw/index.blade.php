...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span> Withdraw</h4>
                        ...
                        <div class="row row_inputs">
                            <div class="col-lg-12 col-md-12 col-6 mb-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="amount" value="{{ old('amount') }}" placeholder="Enter amount to withdraw">
                                    @error('amount')
